...
STRINGS = {
    ...
    "procurement.deadline": {"ja": "提出期限", "en": "Deadline"},
    "procurement.open": {"ja": "受付中", "en": "Open"},
    "procurement.closed": {"ja": "受付終了", "en": "Closed"},
    "procurement.days_left": {"ja": "残り{n}日", "en": "{n} days left"},
    "procurement.today_due": {"ja": "本日締切", "en": "Due today"},
    "procurement.open_count": {"ja": "受付中 {n}件", "en": "{n} open"},

    "companies.filter_ph": {"ja": "社名・技術・地域で絞り込む（例：推進、九州、SAR）",
                            "en": "Filter by name, technology or area"},
    "companies.filter_hit": {"ja": "{n}社を表示中", "en": "Showing {n} companies"},
    "companies.filter_none": {"ja": "条件に合う企業がありません。",
                              "en": "No companies match."},
    "procurement.guide_title": {"ja": "入札・参入の進め方",
                                "en": "How to bid and enter"},
